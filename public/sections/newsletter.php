            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h2 class="section-title float-left pr-lg-5 mr-lg-3 border-lg-right mb-0 display-4"><?php echo esc_html(get_theme_mod( 'serenity_lite_onepage_newsletter_title', __( 'Newsletter', 'serenity-lite' ) ) ); ?></h2>
