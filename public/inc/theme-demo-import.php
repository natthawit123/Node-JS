...
function TDI_import_files() {
	return array(
		array(
			...
			'import_file_url'            => 'https://www.themely.com/download/demo/serenity-lite/content.xml',
			'import_widget_file_url'     => 'https://www.themely.com/download/demo/serenity-lite/widgets.wie',
			'import_customizer_file_url' => 'https://www.themely.com/download/demo/serenity-lite/settings.dat',
		),
	);
}
